...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['created_by'], ['users.id'], name='expense_participants_created_by_fkey'),
    sa.ForeignKeyConstraint(['expense_id'], ['expenses.id'], name='expense_participants_expense_id_fkey'),
    sa.ForeignKeyConstraint(['modified_by'], ['users.id'], name='expense_participants_modified_by_fkey'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='expense_participants_user_id_fkey'),
    sa.PrimaryKeyConstraint('user_id', 'expense_id', name='expense_participants_pkey')
    )
    # ### end Alembic commands ###
